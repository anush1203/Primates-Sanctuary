...
/**
 * A particular species of monkeys called Spider that extends the Abstract Monkey class. Checks if
 * the inputs given to the monkey are valid.
 */
public final class Spider extends AbstractMonkey {
   ...
   */
  public Spider(String monkeyName, String sex, String size, int weight, int age, foodType favFood) 
