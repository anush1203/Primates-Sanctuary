...
/**
 * A particular species of monkeys called Saki that extends the Abstract Monkey class. Checks if the
 * inputs given to the monkey are valid.
 */
public final class Saki extends AbstractMonkey {
   ...
   */
  public Saki(String monkeyName, String sex, String size, int weight, int age, foodType favFood)
