...
/**
 * A particular species of monkeys called Drill that extends the Abstract Monkey class. Checks if
 * the inputs given to the monkey are valid.
 */
public final class Drill extends AbstractMonkey {
   ...
   */
  public Drill(String monkeyName, String sex, String size, int weight, int age, foodType favFood)
